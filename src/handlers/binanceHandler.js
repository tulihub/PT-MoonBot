...
class BinanceHandler {
    ...
    handleBinanceMessage(data) {
        ...
        try {
            orders = Object.assign({}, data.binance.orders);
            balances = Object.assign({}, data.binance.balances);
            markets = Object.assign({}, data.binance.markets);
        } catch (err) {
            logger.debug("error handling binance message: " + err);
        }
        ...
        for (let curr in balances) {
            ...
            if (curr == moonBotMarket) {
                ...
                try {
                    ...
                    logger.warn("problem with loading binance balance of " + curr)
                }
            }
        }
